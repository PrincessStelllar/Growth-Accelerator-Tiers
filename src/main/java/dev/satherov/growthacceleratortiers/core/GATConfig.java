...
public class GATConfig {
    ...
    public int getBoostedIdlePowerConsumption() {
        return common.boostedIdlePowerConsumption.get();
    }

    public double getBoostedSpeedMultiplier() {
        return common.boostedSpeedMultiplier.get();
    }

    public int getCrankedInternalEnergyMultiplier() {
        return common.crankedInternalEnergyMultiplier.get();
    }

    public int getCrankedIdlePowerConsumption() {
        return common.crankedIdlePowerConsumption.get();
    }

    public double getCrankedSpeedMultiplier() {
        return common.crankedSpeedMultiplier.get();
    }

    public int getDirectionalInternalEnergyMultiplier() {
        return common.directionalInternalEnergyMultiplier.get();
    }

    public int getDirectionalIdlePowerConsumption() {
        return common.directionalIdlePowerConsumption.get();
    }

    public double getDirectionalSpeedMultiplier() {
        return common.directionalSpeedMultiplier.get();
    }
